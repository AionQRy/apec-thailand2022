        ...
        <div class="object-2">
            ...
            <div class="box-cat">
                <span class="cat-text">
                    ...
                    <span class="m-y">
                        <?php echo date_i18n( "M Y", $str_format ); ?>
                    </span>
                </span>
            </div>
            <?php
			...
			<a href="<?php echo get_the_permalink(); ?>" class="btn btn-card-two btn-card elementor-animation-grow"><svg viewBox="0 0 24 24" width="24" height="24" stroke="#fff" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg></a>
			</div>
        </div>
    </div>
</article>
